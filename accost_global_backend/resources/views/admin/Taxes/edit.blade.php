                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="card-title">
                                <i class="fas fa-edit text-success"></i> Edit Tax
                                <span class="float-right"><a href="{{ route('list-taxes') }}" class="text-info" data-toggle="tooltip" title="List View"><i class="fas fa-list-alt"></i></a></span>
                            </div>
                        </div>
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    <form id="frm-taxes" method="POST" action="{{ route('update-taxes', $tax->id) }}">
...
@endsection
@section('script')
    @include('admin.Taxes.form-validate')
    <script src="{{ asset('admin/js/pages/taxes/add.js') }}"></script>
@endsection