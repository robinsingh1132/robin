        ...
        <div class="page-inner">
            <div class="page-header">
                ...
                <ul class="breadcrumbs">
                    ...
                    <li class="nav-item">
                        <a href="javascript:void(0);">Edit Product Subcategory</a>
                    </li>
                </ul>
            </div>
            <div class="row">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="card-title">
                                <i class="fas fa-edit text-success"></i> Edit Product Subcategory
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    <form id="frm-pro-subcate" method="POST" action="{{ route('update-pro-subcat',$product_subcategory->id) }}" enctype="multipart/form-data">
