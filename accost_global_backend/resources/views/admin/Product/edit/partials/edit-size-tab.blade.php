<div class="tab-pane wizard-container" id="size" role="tabpanel" ariarequired-labelledby="size-tab">
    ...
    <div class="row pd-3" id="f-pro-size" style="display: none">
        <div class="col-md-12">
            ...
            <form id="s-form-set">
                <div class="form-row align-items-end">
                    ...
                    <div class="col form-group input-group-sm">
                        ...
                        <input type="text" name="o_price" id="s-o-price" class="form-control price_compare" placeholder="Original Price/Unit" size="10" readonly style="background: transparent !important;font-weight: bold; color: black; border: none">
                    </div>
                    <div class="col form-group input-group-sm">
                    ...
                    <div class="col form-group input-group-sm">
                        ...
                        <input type="text" name="s_price" id="s-price" class="form-control price_compare" placeholder="Offered Price/Unit" size="10" autocomplete="off">
                    </div>
                    <div class="col form-group input-group-sm">
    ...
    <div class="form-group">
        <div class="col-md-12 mt-2">
            <form id="product_size" method="POST" action="{{ url('admin/catalog/product/save-size/'.$product->id) }}">
                @csrf
                <button type="submit" class="btn btn-primary other_tabs"><span class="btnrequired-label">
                <i class="fa fa-arrow-alt-circle-up" ></i></span> Update & Continue</button>
