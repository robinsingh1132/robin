        ...
        <div class="col-md-12 ml-auto mr-auto">
            <div class="main-section">
                <form method="post" id="product_image" action="{{route('product-image-upload',$product->id)}}" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <button type="submit" id="image-btn" class="btn btn-primary other_tabs" ><span class="btnrequired-label"><i class="fas fa-arrow-alt-circle-up" ></i></span> Upload Image</button>
