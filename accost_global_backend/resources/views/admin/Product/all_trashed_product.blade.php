                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <div class="card-title"><a href="{{route('product-list')}}">
                                <i class="fas fa-arrow-circle-left text-success" title="back to list"></i>
                                Trash Products List </a>   
                                <span class="float-right  mr-3"><a href="{{ route('restore-all-product') }}" class="text-info" data-toggle="tooltip" title="restore all"><i class="fas fa-window-restore"></i></a></span>
                                <!-- <span class="float-right  mr-3"><a href="{{ route('trash') }}" class="text-info" data-toggle="tooltip" title="trash"><i class="fas fa-trash"></i></a></span> -->                           
    ...
    <script>
        $(function() {
            ...
            $('#delSelected').on('click',function(event) {
                ...
                $.ajax({
                    url: "{{route('delete-all-trash-product')}}",
                    type: 'DELETE',
