{{--Modal Message Filter start--}}
<div class="modal fade" id="filterMessage" role="dialog">
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            <form id="filter-messages" method="GET" action="{{ route('filter-messages') }}">
            @csrf
                <div class="modal-header">
                    <h4 class="modal-title">Message Filter</h4>
