        ...
        <div class="page-inner">
            <div class="page-header">
                ...
                <ul class="breadcrumbs">
                    ...
                    <li class="nav-item">
                        <a href="javascript:void(0);">New Product Super Category</a>
                    </li>
                </ul>
            </div>
            <div class="row">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="card-title">
                                <i class="fas fa-plus-circle text-success"></i> New Product Super Category
                                <span class="float-right"><a href="{{ route('listSuperCategory') }}" class="text-info" data-toggle="tooltip" title="List View"><i class="fas fa-list-alt"></i></a></span>
                            </div>
                        </div>
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    <form id="frm-pro-cate" method="POST" action="{{ route('saveSuperCategory') }}" enctype="multipart/form-data">
